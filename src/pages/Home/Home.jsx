...
import { getAllAdverts } from '../../redux/car/Operations.js';
import { selectAdverts } from '../../redux/car/Selectors.js';
import { ModalCarImg } from '../../components/Info/Info.styled';
import {
  FeaturedStyled,
      ...
      <FeaturedWrap>
        <FeaturedStyled>
          ...
          <div className="h-96 carousel carousel-vertical rounded-box">
            {adverts.slice(0, 6).map((advert, index) => (
